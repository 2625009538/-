...
#         index_tensor = torch.tensor(indices[i: min(i + batch_size, nums_example)])# 这里写的很有意思
...
# bbb = torch.tensor([10,11,12,13,14,16,16,17])
# print(bbb[[2,3,4]])
...
print('aa',tree)
dist, ind = tree.query([[0.5,0.5,0.5],[0.2,0.2,0.2],[5,5,5]], k=3)
